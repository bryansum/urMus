...
@optional
- (void) serverDidEnableBonjour:(AsyncUdpSocket*)server withName:(NSString*)name;
- (void) server:(AsyncUdpSocket*)server didNotEnableBonjour:(NSDictionary *)errorDict;
...
@property(assign) id<AsyncUdpSocketDelegate> delegate;
